...
export const products: ProductData[] = [
  {
    ...
    posts: [
      ...
      {
        id: 'codex-2026-08-30-reset-ann',
        signal: 'heads-up',
        date: '2026-08-29T20:43:00.000Z',
        summary:
          'We are resetting usage limits for all paid Codex and ChatGPT Work users. The reset will take effect around 2:30pm Pacific.',
        summaryZh:
          '我们正在为 Codex 和 ChatGPT Work 的所有付费用户重置用量限额，预计太平洋时间下午 2:30 生效。',
        author: 'Tibo',
        authorZh: 'Tibo',
        handle: '@thsottiaux',
        avatarInitials: 'TS',
      ...
      {
        id: 'codex-2026-08-28-reset',
        date: '2026-08-27T16:35:00.000Z',
        summary:
          'A whole new me, and a whole new usage allowance for all ChatGPT Work and Codex users.',
        summaryZh:
          '全新的我，以及面向所有 ChatGPT Work 和 Codex 用户的全新用量额度。',
        author: 'Tibo',
        authorZh: 'Tibo',
        handle: '@thsottiaux',
        avatarInitials: 'TS',
      ...
      },
      {
        ...
        summary:
          'Not so random, but yes — usage was reset.',
        summaryZh:
          '并不是那么随机，但确实如此——用量已经重置。',
        author: 'Tibo',
        authorZh: 'Tibo',
        handle: '@thsottiaux',
        avatarInitials: 'TS',
    ...
    events: [
      // ——— September (AIHOT-normalized: 2 all-user resets, 3 card issuances) ———
      {
        date: '2026-09-12T08:09:00.000Z',
        kind: 'usage_reset',
        scope: 'all users',
      ...
      },
      {
        ...
        scopeZh: '付费 / 等待用户',
        note: 'Astra rollout banked-card issuance — grouped announcement and delivery updates',
        noteZh: 'Astra 上线重置卡发放 — 公告与到账更新合并为一轮',
        countsForEstimate: false,
        inMainHistory: true,
        postIds: [
          'codex-2026-09-05-reset',
          'codex-2026-09-05-banked',
          'codex-2026-09-04-banked',
        ],
      },
      {
        date: '2026-09-03T23:12:00.000Z',
      ...
      // ——— August ———
      {
        ...
        countsForEstimate: true,
        inMainHistory: true,
        postIds: ['codex-2026-08-31-reset'],
      },
      {
        date: '2026-08-30T19:24:00.000Z',
        kind: 'usage_reset',
      ...
      },
      {
        ...
        scope: 'all paid ChatGPT Work + Codex',
        scopeZh: '全体付费 ChatGPT Work + Codex',
        note: 'Reset announced for 2:30pm Pacific',
        noteZh: '预告太平洋时间下午 2:30 重置',
        countsForEstimate: false,
        inMainHistory: true,
        postIds: ['codex-2026-08-30-reset-ann'],
      },
      {
        date: '2026-08-27T16:35:00.000Z',
        kind: 'usage_reset',
        scope: 'all ChatGPT Work + Codex',
        scopeZh: '全体 ChatGPT Work + Codex',
        note: 'Usage allowance reset confirmed',
        noteZh: '全新用量额度已确认',
        countsForEstimate: true,
        inMainHistory: true,
        postIds: ['codex-2026-08-28-reset'],
      },
      {
        date: '2026-08-25T18:20:00.000Z',
        kind: 'usage_reset',
        ...
        scopeZh: '全体付费计划',
        note: 'Usage reset confirmed in reply',
        noteZh: '回复中确认用量重置',
        countsForEstimate: true,
        inMainHistory: true,
      ...
      },
      {
        ...
        inMainHistory: true,
        postIds: [
          'codex-2026-08-22-banked',
          'codex-2026-08-21-banked-arrive',
          'codex-2026-08-21-banked-ann',
        ],
      },
      {
        date: '2026-08-13T01:01:00.000Z',
  ...
  },
  {
    ...
    posts: [
      {
        id: 'claude-2026-08-29-limit-change',
        date: '2026-08-29T16:47:23.947Z',
        summary:
          'Standard weekly limits will rise permanently by 25% from September 14; the temporary 50% increase remains through September 13. This changes the ceiling but does not reset counters.',
        summaryZh:
          '标准周限额将从 9 月 14 日起永久提高 25%，临时提高 50% 的安排延续至 9 月 13 日。这是额度上调，并未清空已用计数。',
        author: 'Claude Developers',
        authorZh: 'Claude Developers',
        handle: '@ClaudeDevs',
        avatarInitials: 'CD',
      ...
      {
        id: 'claude-2026-08-18-limit-change',
        date: '2026-08-18T19:35:49.880Z',
        summary:
          'The temporary 50% higher Claude Code weekly limits were extended through August 31. This was a capacity increase, not a usage reset.',
        summaryZh:
          'Claude Code 周限额临时提高 50% 的安排延长至 8 月 31 日。这是容量上调，不是用量重置。',
        author: 'Claude Developers',
        authorZh: 'Claude Developers',
        handle: '@ClaudeDevs',
        avatarInitials: 'CD',
    ...
    events: [
      {
        date: '2026-08-29T16:47:23.947Z',
        kind: 'special',
        scope: 'Pro, Max, Team and seat-based Enterprise',
        scopeZh: 'Pro、Max、Team 与席位制 Enterprise',
        note: 'Weekly limit increase announced — not a reset',
        noteZh: '周限额上调公告 — 非重置',
        countsForEstimate: false,
        inMainHistory: true,
        postIds: ['claude-2026-08-29-limit-change'],
        markerLabel: 'Limit +25%',
        markerLabelZh: '周限额 +25%',
      },
      {
        date: '2026-08-18T19:35:49.880Z',
        kind: 'special',
        scope: 'paid Claude Code plans',
        scopeZh: 'Claude Code 付费计划',
        note: 'Temporary 50% weekly-limit increase extended — not a reset',
        noteZh: '周限额临时 +50% 延期 — 非重置',
        countsForEstimate: false,
        inMainHistory: true,
        postIds: ['claude-2026-08-18-limit-change'],
        markerLabel: 'Limit +50%',
        markerLabelZh: '周限额 +50%',
      },
      {
        date: '2026-09-04T20:08:00.000Z',
        kind: 'usage_reset',
  ...
  },
  {
    ...
    posts: [
      {
        id: 'grok-2026-09-05-reset',
        date: '2026-09-05T20:19:00.000Z',
        summary:
          'Grok Bot usage limits reset. The @bot team confirmed that usage limits were reset for all Grok Bot users.',
        summaryZh:
          'Grok Bot 用量限额已重置；@bot 团队确认已为所有 Grok Bot 用户重置用量限额。',
        author: 'Elon Musk',
        authorZh: '埃隆·马斯克',
        handle: '@elonmusk',
        avatarInitials: 'EM',
        avatarUrl: '/elon-avatar.jpg',
        url: 'https://x.com/elonmusk/status/2096425140716192241',
      },
      {
        id: 'grok-2026-08-26-reset',
        date: '2026-08-26T19:12:39.463Z',
        summary:
          'All SuperGrok and Cursor Pro subscribers now have access to Grok Bot. Weekly usage limits are also being reset for all Grok Bot users.',
        summaryZh:
          '所有 SuperGrok 和 Cursor Pro 订阅用户现可使用 Grok Bot，同时为所有 Grok Bot 用户重置周用量限额。',
        author: 'Elon Musk',
        authorZh: '埃隆·马斯克',
        handle: '@elonmusk',
        avatarInitials: 'EM',
      ...
      {
        id: 'grok-2026-08-13-token',
        date: '2026-08-13T18:41:11.240Z',
        summary:
          'Rate-limit reset signal during the Grok 4.6 rollout. Eligible users received a one-time reset token in Settings.',
        summaryZh:
          'Grok 4.6 上线期间的限额重置信号；符合条件的用户可在设置中领取并兑换一次性重置 token。',
        author: 'Baconbrix',
        authorZh: 'Baconbrix（xAI）',
        handle: '@Baconbrix',
        avatarInitials: 'XB',
        url: 'https://x.com/Baconbrix/status/2087972751365804179',
      },
      {
        id: 'grok-2026-09-01',
    ...
    events: [
      {
        date: '2026-09-05T20:19:00.000Z',
        kind: 'token_reset',
        scope: 'all Grok Bot users',
        scopeZh: '所有 Grok Bot 用户',
        note: 'Usage limits reset confirmed by @bot and Elon Musk',
        noteZh: '@bot 与马斯克确认用量限额已重置',
        countsForEstimate: true,
        inMainHistory: true,
        postIds: ['grok-2026-09-05-reset'],
      },
      {
        date: '2026-08-26T19:12:39.463Z',
        kind: 'token_reset',
        scope: 'all Grok Bot users',
        scopeZh: '所有 Grok Bot 用户',
        note: 'Weekly usage limits reset with expanded Grok Bot access',
        noteZh: 'Grok Bot 扩大开放时重置周用量限额',
        countsForEstimate: true,
        inMainHistory: true,
        postIds: ['grok-2026-08-26-reset'],
      },
      {
        date: '2026-08-13T18:41:11.240Z',
        kind: 'reset_card',
        scope: 'eligible Grok 4.6 users',
        scopeZh: '符合条件的 Grok 4.6 用户',
        note: 'One-time reset token issued during rollout',
        noteZh: '上线期间发放一次性重置 token',
        countsForEstimate: false,
        inMainHistory: true,
        postIds: ['grok-2026-08-13-token'],
      },
      {
        date: '2026-09-01T12:00:00.000Z',
        kind: 'token_reset',
